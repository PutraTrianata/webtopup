...
<head>
  ...
  <title>NotFaceN Store - Clash Of Clans</title>
    ...
    <header>
      ...
      <div class="game-banner">
        ...
        <div class="game-logo-large">
            <img src="img/imageCOC.png" alt="Clash Of Clans">
          <div class="game-info">
            <p>Proses Cepat</p>
            <p>Pembayaran Aman</p>
            <p>Layanan 24 Jam</p>
      ...
      <script>
        ...
        //   const server = document.getElementById('server').value;
          ...
          window.location.href = `konfirmasiCOC.html?user_id=${encodeURIComponent(userId)}&package=${encodeURIComponent(packageName)}`;
        }
      </script>
