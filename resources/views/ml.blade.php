...
<head>
  ...
  <title>NotFaceN Store - Mobile Legend</title>
    ...
    <header>
      ...
      <div class="game-banner">
        ...
        <div class="game-logo-large">
          <img src="img/imageML.png" alt="Mobile Legend">
          <div class="game-info">
            <p>Proses Cepat</p>
            <p>Pembayaran Aman</p>
            <p>Layanan 24 Jam</p>
      ...
      <script>
        ...
        function submitForm(packageName) {
          ...
          // Validate the form
          if (!userId || !server) {
            alert('Silakan masukkan ID dan Server terlebih dahulu!');
            return;
          }
          
          // Redirect to confirmation page with parameters
          window.location.href = `konfirmasiML.html?user_id=${encodeURIComponent(userId)}&server=${encodeURIComponent(server)}&package=${encodeURIComponent(packageName)}`;
        }
      </script>
